...
public class Ex10 {
    public static void main(String[] args) {
            ...
            for (int j = 0; j < matriz[i].length; j++) {
                if (j+3<19) {
                    if(matriz[i][j]*matriz[i][j+1]*matriz[i][j+2]*matriz[i][j+3]>maiorProduto){
                        ...
                        elemento3=matriz[i][j+2];
                        elemento4=matriz[i][j+3];
                    }
                }
                if (i+3<19) {
                    if(matriz[i][j]*matriz[i+1][j]*matriz[i+2][j]*matriz[i+3][j]>maiorProduto){
                        ...
                        elemento1=matriz[i][j];
                        elemento2=matriz[i+1][j];
                        elemento3=matriz[i+2][j];
                        elemento4=matriz[i+3][j];
                    }
                }
                if (i+3<19 && j+3<19) {
                    if(matriz[i][j]*matriz[i+1][j+1]*matriz[i+2][j+2]*matriz[i+3][j+3]>maiorProduto){
                        ...
                        elemento1=matriz[i][j];
                        elemento2=matriz[i+1][j+1];
                        elemento3=matriz[i+2][j+2];
                        elemento4=matriz[i+3][j+3];
                    }
                }
            }
        }
        ...
        System.out.println("Elemento 4: "+ elemento4);
        System.out.println("Maior produto de 4 elementos: "+ maiorProduto);
